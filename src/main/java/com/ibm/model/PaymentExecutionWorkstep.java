 ...
 */
@Schema(name = "PaymentExecutionWorkstep", description = "The main worsteps to be followed in th eexecution of the procedure  Examples: Invoice generation")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2025-07-02T09:07:33.007512365Z[GMT]")public class PaymentExecutionWorkstep {
  ...
  */
    @Schema(name = "PaymentExecutionTaskResult", description = "Details of the execution transaction", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
